...
Developer : ae0zk
#༒♪𝑨𝑳𝑶𝑺𝑯 ☬
سورس الامراء افضل سورس حمايه بوتات تلكرام 
*/
<?php
ob_start();
error_reporting(0);
define('5876064963:AAFNGTCBFdwsXyxUOdvNvH23-urX_69atcc);
...
$Dev = array(5516006497); //ID ADMIN NUMBER 1 HE CHAT
@$usernamebot = "@cors1ali_bot"; //UserName Bot
@$channel = "Bots_Dark"; // UserName Channel don't @
@$token = API_KEY;
